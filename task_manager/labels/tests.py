...
class LabelViewsTest(LabelTestCase):
    ...
    def test_create_label(self):
        ...
        self.assertEqual(
            Label.objects.filter(pk=self.count + 1)[0].label,
            self.valid_data.get("label"),
        )
    ...
    def test_update_label(self):
        ...
        self.assertRedirects(response, reverse("labels_list"))
        self.assertEqual(
            Label.objects.get(id=id).label,
            self.update_data.get("label"),
        )
    ...
    def test_delete_label(self):
        ...
        self.assertRedirects(response, reverse("labels_list"))
        self.assertEqual(Label.objects.count(), self.count - 1)
        self.assertEqual(Label.objects.get(id=id).label, self.label2.label)
