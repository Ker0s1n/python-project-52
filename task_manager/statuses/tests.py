...
class StatusTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.valid_status_data = self.data.get("new_status")
        self.update_status_data = self.data.get("update_status")
...
class StatusViewsTest(StatusTestCase):
    ...
    def test_create_status(self):
        ...
        self.assertEqual(
            Status.objects.filter(pk=self.status_count + 1)[0].status,
            self.valid_status_data.get("status"),
        )
    ...
    def test_update_status(self):
        ...
        self.assertRedirects(response, reverse("statuses_list"))
        self.assertEqual(
            Status.objects.get(id=id).status,
            self.update_status_data.get("status"),
        )
